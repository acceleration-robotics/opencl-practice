...
void CLImageProc::processImage(const sensor_msgs::msg::Image::SharedPtr msg) { 
    ...
    std::ofstream myfile;
    myfile.open("/home/user/DEVELOPMENT/ros_ws/analyses/rectify_resize_cpu.csv", std::ios::app);
    myfile << new_line;

    // Save the image using OpenCV
    std::string filename = "/home/user/DEVELOPMENT/ros_ws/saved_images/cpu_rectify_resize_" + std::to_string(image_count_) + ".png";

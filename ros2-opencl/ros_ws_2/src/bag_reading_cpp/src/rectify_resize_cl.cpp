#include <bag_reading_cpp/rectify_resize_cl.hpp>
...
RectifyResizeCL::RectifyResizeCL(const rclcpp::NodeOptions &options)
    : Node("image_reader_node", options)
{
    ...
    // Create image pub
    pub_image_ = image_transport::create_camera_publisher(this, "rectify");
    // Create image sub
    sub_image_ = image_transport::create_camera_subscription(
        this, "image",
        std::bind(
        &RectifyResizeCL::imageCb, this,
        std::placeholders::_1,
        std::placeholders::_2), "raw");

}

RectifyResizeCL::~RectifyResizeCL()
{
    
}

size_t RectifyResizeCL::get_msg_size(sensor_msgs::msg::Image::ConstSharedPtr image_msg){
...
size_t RectifyResizeCL::get_msg_size(sensor_msgs::msg::CameraInfo::ConstSharedPtr msg){
  ...
  const void* info_ptr = reinterpret_cast<const void*>(msg.get());
...
void RectifyResizeCL::imageCb(sensor_msgs::msg::Image::ConstSharedPtr image_msg,
...
void RectifyResizeCL::initializeOpenCL()
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(image_proc::RectifyResizeCL)

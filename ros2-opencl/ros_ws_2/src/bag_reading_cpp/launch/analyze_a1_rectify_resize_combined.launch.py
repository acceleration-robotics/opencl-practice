...
def main(argv):
    ...
    ba = BenchmarkAnalyzer('a1_rectify_resize_combined', hardware_device_type)
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "/root/DEVELOPMENT/ros_ws/src/bag_reading_cpp/launch/analyze_a1_rectify_resize_combined.launch.py",

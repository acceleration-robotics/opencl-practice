        ...
        ba.add_target(
            {
                ...
                "name_disambiguous": "ros2_image_pipeline:image_proc_rectiy_cb_init",
                "colors_fg": "blue",
                "colors_fg_bokeh": "darkgray",
                "layer": "userland",
                "label_layer": 4,
...
def generate_launch_description():
    ...
    analyzer = ExecuteProcess(
        cmd=[
            'python3', "/root/DEVELOPMENT/ros_ws/src/bag_reading_cpp/launch/analyze_a5_rectify.launch.py",
